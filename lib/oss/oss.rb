...
module OSS
  ...
  class Connection
    ...
    def put(path, file, options={})
      ...
      content_md5  = Digest::MD5.hexdigest(file).upcase
      content_type = options[:content_type] || "image/jpg"
      cache        = options[:content_control] || "max-age=31536000"
      date         = gmtdate
  ...
  class File
    ...
    def oss_connection
      ...
      @oss_connection ||= OSS::Connection.new(config)
    end
